	...
	public static void createTable() throws IOException
	{
		...
		try {
			 HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("Lab2SivaKrishna"); 
	...
	public static void insertTable() throws IOException{
        ...
        config.set("hbase.master", "134.193.136.147:60010");
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",h="",t="";
		  ...
		  HTable table = new HTable(config, "Lab2SivaKrishna");
        ...
        BufferedReader br = null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C:/Users/Siva Krishna/Desktop/sensor_siva.txt"));
...
//		    System.out.println(res.toString());
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("Lab2SivaKrishna");
         admin.deleteTable("Lab2SivaKrishna");
